...
const ViewOffreStageComponent = () => {
    ...
    const goToListOffres = () => {
        navigate('/stages-offres/list');  // Adjust route to your list of internship offers
    };

    const goUpdateOffre = () => {
        navigate(`/update-offre-stage/${id}`);
    };
                    ...
                    <div className="container">
                        <Card title={<Title level={2}>{`Détails de l'offre de stage ${offreStage.titreOffreStage}`}</Title>} className="card-container">
                            ...
                            <div style={{ marginTop: '20px' }}>
                                ...
                                <Button type="primary" onClick={goUpdateOffre} style={{ marginLeft: '10px' }}>
                                    Modifier l'offre
                                </Button>
                            </div>
                        </Card>
