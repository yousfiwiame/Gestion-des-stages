                            ...
                            <Row gutter={16}>
                                ...
                                <Col span={16}>
                                    <Descriptions bordered column={1} labelStyle={{ fontWeight: 'bold' }}>
                                        ...
                                        <Descriptions.Item label="Nom d'utilisateur">{etudiant.username}</Descriptions.Item>
                                        ...
                                        <Descriptions.Item label="Statut de stage">{etudiant.statut}</Descriptions.Item>
