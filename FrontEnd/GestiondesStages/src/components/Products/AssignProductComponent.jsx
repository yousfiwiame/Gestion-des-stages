...
import { getEtudiant, assignProductToEtudiant, getAssignedProductsByEtudiantId } from '../../service/EtudiantService';
...
import HeaderEtudiant from '../Etudiants/HeaderEtudiant';
import './Product.css';
...
const AssignProductsComponent = () => {
    ...
    const handleAssignProduct = () => {
        ...
        Promise.all(selectedProducts.map(productId => {
            ...
            return assignProductToEtudiant(id, product);
        }))
        .then(() => {
            ...
            <Layout className="site-layout">
                ...
                <Content style={{ margin: '0 16px' }}>
                    <div className="container">
                        <Card title={<Title level={2}>{`Affecter les biens à ${etudiant ? `${etudiant.firstName} ${etudiant.lastName}` : 'Étudiant'}`}</Title>} className="card-container">
                            <Select
                                style={{ width: '100%' }}
